...
mixin _$ValueFailure<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(T failedValue, int max) shortPassword,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(T failedValue, int max)? shortPassword,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ShortPassword<T> implements ShortPassword<T> {
  const _$ShortPassword({required this.failedValue, required this.max});
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.shortPassword(failedValue: $failedValue, max: $max)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return shortPassword(failedValue, max);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return shortPassword?.call(failedValue, max);
  }
...
abstract class ShortPassword<T> implements ValueFailure<T> {
  const factory ShortPassword(
      {required final T failedValue,
      required final int max}) = _$ShortPassword<T>;
